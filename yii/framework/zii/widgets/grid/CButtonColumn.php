...
class CButtonColumn extends CGridColumn
{
	...
	/**
	 * @var string the label for the add button. Defaults to "add".
	 * Note that the label will not be HTML-encoded when rendering.
	 */
	public $addButtonLabel='Añadir';
	/**
	 ...
	 * and <code>$this</code> the column object.
	 */
	public $addButtonUrl='Yii::app()->controller->createUrl("create",array("id"=>$data->primaryKey))';
	/**
	...
	protected function initDefaultButtons()
	{
		...
		if($this->addButtonImageUrl===null)
			$this->addButtonImageUrl=$this->grid->baseScriptUrl.'/plus.png';
		if($this->deleteButtonImageUrl===null)
			$this->deleteButtonImageUrl=$this->grid->baseScriptUrl.'/delete.png';
		if($this->deleteConfirmation===null)
			$this->deleteConfirmation=Yii::t('zii','Are you sure you want to delete this item?');

		foreach(array('view','update','add','delete') as $id)
		{
			$button=array(
